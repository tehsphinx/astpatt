...
var matchTests = []struct {
	...
	{
		patterns: []string{"solutions/twofer/1", "solutions/twofer/4"},
		tests: []test{
			...
			{solution: "solutions/twofer/7", match: true},
		},
	},
	{
		patterns: []string{"solutions/hamming/3", "solutions/hamming/6"},
		tests: []test{
	...
	},
	{
		...
		tests: []test{
			...
			{solution: "solutions/raindrops/3", match: true},
	...
	},
	{
		...
		tests: []test{
			...
			{solution: "solutions/raindrops/12", match: true},
			{solution: "solutions/raindrops/13", match: false},
			{solution: "solutions/raindrops/14", match: false},
			{solution: "solutions/raindrops/15", match: false},
			{solution: "solutions/raindrops/16", match: false},
